...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! on the computer's next turn,the computer will get a guaranteed hit."
        static let ComputerHitMonster = "The computer has hit a sea monster! On your next turn,you'll get a guaranteed hit."
